...
- **JIT files location:** since slice B merged, the uncommitted JIT edits ride with the branch checked out in the primary tree (`/home/claude/OpenAd`, currently `feat/publisher-growth`).
