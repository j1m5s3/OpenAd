...
**What happens when a period ends?** The **lease** expires. There is no auto-renew.
Buy the next period if you want it.

**Can I run HTML or JavaScript ads?** No. Raster images only (and NFT_REF).
