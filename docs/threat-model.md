...
- T18's verify pass has no concurrency of its own — pending creatives within one pass are
  ...
  of their own pending creative — each one bounded and connection-releasing, but not rate
  limited.
